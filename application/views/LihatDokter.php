                ...
                <tbody>
                    <tr><?php foreach ($dokter as $dr) : ?>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url(); ?>dokter/hapus/<?= $dr['id_dokter'] ?>" class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin menghapus data ini?');" ?>hapus</a>
                             <a href="<?= base_url ('dokter/ubah') ?>" class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin mengubah data ini?');" ?>ubah</a>
 ...
 -->                        </td>
            ...
            <div class="row mt-3">
                <div class="col md-6 text-center mt-5">
                    <a href="<?= site_url('dokter/TambahDokter') ?>" class="btn btn-primary">Tambah Data Mahasiswa</a>
                </div>
            </div>
