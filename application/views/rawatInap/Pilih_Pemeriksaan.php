...
<div class="container">
    ...
    <div class="row mt-5">
    	<div class="col">
    		<h3 class="text-center">Pilih Pemeriksaan Pasien</h3>
                ...
                <tbody>
                    <tr><?php foreach ($periksa as $pk) : ?>
                        ...
                        <td class="text-center">
                            <a href="<?= base_url(); ?>index.php/rawatInap/PilihKamar/<?= $pk['id_pemeriksaan'] ?>" class="badge badge-danger float-center" onclick="return confirm('Apakah anda yakin memilih data ini?');" ?>pilih</a>            
                        </td>
                    </tr>
                    <?php endforeach ?>
                </tbody>
